...
export const canisterId = process.env.CANISTER_ID_GAME_STATE_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./game_state_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the game_state_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./game_state_canister.did.js")._SERVICE>}
 */
export const game_state_canister = createActor(canisterId);
