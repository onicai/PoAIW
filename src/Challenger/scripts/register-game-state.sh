...
output=$(icp canister call challenger_ctrlb_canister setGameStateCanisterId "(\"$CANISTER_ID_GAME_STATE_CANISTER\")" -e $NETWORK_TYPE)
...
icp canister settings update challenger_ctrlb_canister --add-controller $CANISTER_ID_GAME_STATE_CANISTER -e $NETWORK_TYPE