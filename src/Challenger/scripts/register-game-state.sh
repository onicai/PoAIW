...
echo " "
echo "--------------------------------------------------"
echo "Registering GameState with the challenger_ctrlb_canister"
output=$(dfx canister call challenger_ctrlb_canister setGameStateCanisterId "(\"$CANISTER_ID_GAME_STATE_CANISTER\")" --network $NETWORK_TYPE)
...
echo " "
echo "--------------------------------------------------"
echo "Make GameState $CANISTER_ID_GAME_STATE_CANISTER a controller of the challenger_ctrlb_canister"
dfx canister update-settings challenger_ctrlb_canister --add-controller $CANISTER_ID_GAME_STATE_CANISTER --network $NETWORK_TYPE