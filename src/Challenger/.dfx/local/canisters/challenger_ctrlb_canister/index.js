...
import { idlFactory } from './challenger_ctrlb_canister.did.js';
export { idlFactory } from './challenger_ctrlb_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CHALLENGER_CTRLB_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./challenger_ctrlb_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the challenger_ctrlb_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./challenger_ctrlb_canister.did.js")._SERVICE>}
 */
export const challenger_ctrlb_canister = createActor(canisterId);
