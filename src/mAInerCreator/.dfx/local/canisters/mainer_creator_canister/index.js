...
import { idlFactory } from './mainer_creator_canister.did.js';
export { idlFactory } from './mainer_creator_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MAINER_CREATOR_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mainer_creator_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mainer_creator_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mainer_creator_canister.did.js")._SERVICE>}
 */
export const mainer_creator_canister = createActor(canisterId);
