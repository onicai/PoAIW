        ...
        --network)
            ...
            if [ "$1" = "local" ] || [ "$1" = "ic" ]; then
                ...
                if [ "$NETWORK_TYPE" = "ic" ]; then
                    CANISTER_ID_MAINER_CTRLB_CANISTER="x6o6k-kqaaa-aaaaj-az4pa-cai"
                fi
            else
...
echo "Making $CANISTER_ID_MAINER_CTRLB_CANISTER a controller of LLMs"
...
do
    echo "==================================================="
    echo "Making $CANISTER_ID_MAINER_CTRLB_CANISTER a controller of llm_$i"
